  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
        ...
        {isOwner && (
          <button onClick={openForm} className="btn-primary text-sm py-2 justify-center"><FiPlus /> Terbitkan License</button>
        )}
      </div>
      ...
      {showForm && isOwner && (
        <div className="fixed inset-0 bg-black/40 flex items-start sm:items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md space-y-4 my-8 sm:my-0 max-h-[90vh] overflow-y-auto">
